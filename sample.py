...
json.dump(data_1, open('data_1.json', 'w'), indent=4)

data_2 = client.get_all(sample_url_2)
json.dump(data_2, open('data_2.json', 'w'), indent=4)

data_3 = client.get_all(sample_url_3)
json.dump(data_3, open('data_3.json', 'w'), indent=4)

data_4 = client.get_all(sample_url_4)
json.dump(data_4, open('data_4.json', 'w'), indent=4)
